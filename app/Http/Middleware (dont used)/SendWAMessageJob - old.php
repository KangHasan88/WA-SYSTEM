...
class SendWAMessageJob implements ShouldQueue
{
    ...
    public function __construct($number, $message, $imageUrl = null, $title = null)
    {
        $this->number = $number;
    ...
    public function handle(): void
    {
        ...
        Log::info("Queue Connection: " . $this->connection);
        Log::info("Queue Name: " . ($this->queue ?? 'default'));
